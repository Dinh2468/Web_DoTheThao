...
require_once $root_path . '/classes/Sanpham.class.php'; 
require_once $root_path . '/classes/Loaisp.class.php';  
class SanphamController
{
    ...
    // VALIDATE dùng để kiểm tra dữ liệu đầu vào trước khi thêm/sửa
