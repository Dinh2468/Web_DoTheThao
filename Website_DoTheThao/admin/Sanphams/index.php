...
// Nhúng các Model hỗ trợ hiển thị (nếu cần, ví dụ: để lấy tên Nhà cung cấp)
// require_once '../../classes/NhaCungCap.class.php'; 

// Xử lý thông báo sau khi thêm/sửa/xóa thành công
$message = null;
