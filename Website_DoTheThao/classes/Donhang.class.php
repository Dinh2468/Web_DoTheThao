...
class Donhang
{
    ...
    // Thuộc tính của đối tượng Đơn hàng
    public $donhang_id;
    public $khachhang_id;
    public $nhanvien_id; // Nhân viên xử lý đơn hàng (tùy chọn)
    public $ngay_dat;
    public $tong_tien;
    ...
    /**
     * Lấy tất cả đơn hàng, bao gồm tên khách hàng và nhân viên.
     */
    ...
    /**
     * Thêm một đơn hàng và chi tiết đơn hàng (Cần Transaction).
     * @param array $data Dữ liệu đơn hàng.
     * @param array $items Chi tiết các sản phẩm trong đơn hàng.
     */
    public function createDonhang($data, $items)
    {
        ...
        try {
            ...
            // 2. INSERT vào bảng chitiet_donhang
            foreach ($items as $item) {
                ...
                // TODO: 3. Cập nhật số lượng tồn kho của sản phẩm
            }
    ...
    /**
     * Xóa một đơn hàng (Cần Transaction để xóa cả chi tiết).
     */
    ...
    /**
     * Lấy chuỗi mô tả trạng thái đơn hàng (ví dụ: 'pending' -> 'Đang chờ xử lý').
     */
