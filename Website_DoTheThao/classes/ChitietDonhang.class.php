...
class ChitietDonhang
{
    ...
    // Thuộc tính của đối tượng Chi tiết Đơn hàng
    public $donhang_id;
    public $sanpham_id;
    public $so_luong;
    public $gia_ban; // Giá bán tại thời điểm đặt hàng
    public $thanh_tien;

    // Thuộc tính hiển thị (tên sản phẩm được JOIN từ bảng sanpham)
    public $ten_sanpham;
    ...
    /**
     * Lấy tất cả chi tiết đơn hàng thuộc về một đơn hàng cụ thể.
     * @param int $donhang_id ID của đơn hàng.
     */
    ...
    /**
     * Lấy chi tiết một mục sản phẩm cụ thể trong đơn hàng.
     * (Thường sử dụng Donhang_ID và Sanpham_ID làm khóa chính kép)
     */
    ...
    // ======================================================================
    // PHƯƠNG THỨC THAO TÁC (CREATE, DELETE)
    // ======================================================================

    /**
     * Thêm một mục sản phẩm vào chi tiết đơn hàng.
     * (Phương thức này thường được gọi trong transaction của Donhang::createDonhang)
     * @param array $data Dữ liệu chi tiết đơn hàng.
     */
    ...
    /**
     * Xóa tất cả chi tiết đơn hàng thuộc về một đơn hàng (Thường được gọi bởi Donhang::delete).
     */
