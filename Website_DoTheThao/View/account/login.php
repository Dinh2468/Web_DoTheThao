...
// Khối xử lý đăng nhập (Sẽ được viết sau)
        ...
        <div class="col-md-6 col-lg-5">
            <div class="login-form-wrapper">
                ...
                if (isset($_SESSION['error'])): ?>
                    ...
                    <?php unset($_SESSION['error']); // Xóa biến session sau khi hiển thị 
                    ?>
                <?php endif; ?>
                ...
                <?php if (isset($_SESSION['message'])): ?>
                    ...
                    <?php unset($_SESSION['message']); // Xóa biến session sau khi hiển thị 
                    ?>
                <?php endif; ?>
